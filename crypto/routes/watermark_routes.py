...
def api_watermark_image():
    ...
    try:
        ...
        token, _     = save_watermark_output(out_bytes, out_filename)
...
def api_watermark_source_code():
    ...
    try:
        ...
        code_token, _ = save_watermark_output(protected_bytes, out_filename)

        sig_filename = f"{filename}.sig"
        sig_token, _ = save_watermark_output(sig_bytes, sig_filename)

...
def sign_file(file_path_or_bytes: Union[str, bytes]) -> Tuple[bytes, str]:
    ...
    Args:
        file_path_or_bytes: Path to file (str) or raw file content (bytes).
...
def verify_signature(
    ...
    Args:
        file_path_or_bytes: Content file path (str) or raw bytes.
        signature_input:    Signature as raw bytes or hex string.
